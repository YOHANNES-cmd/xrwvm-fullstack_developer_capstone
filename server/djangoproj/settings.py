...
ALLOWED_HOSTS = [
    'localhost',
    '127.0.0.1',
    'yohanneskonk-8000.theianext-0-labs-prod-misc-tools-us-east-0.proxy.cognitiveclass.ai',
    'yohanneskonk-8000.theiadockernext-1-labs-prod-theiak8s-4-tor01.proxy.cognitiveclass.ai'
]
